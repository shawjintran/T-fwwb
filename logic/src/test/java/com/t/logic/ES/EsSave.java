...
import com.t.logic.entity.Bo.EsDocumentBo;
...
public class EsSave {
    ...
    void testBulkRequest(){
        ...
        for (int i = 0; i < 3; i++) {
            ...
            esDocumentBo.setPdfId(new Long(1200000000l));
            esDocumentBo.setPdfPage(1+i);
            ...
            esDocumentBo.setAll("图片");
            esDocumentBo.setDocId(0l);
            esDocumentBo.setUserId(0l);
